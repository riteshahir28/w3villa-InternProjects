            ...
            <div>
              ...
              <div className="space-y-3">
                <div className="flex items-center">
                  ...
                  />
                  <label htmlFor="role-user" className="ml-3 block text-sm text-gray-700">
                    <div className="flex items-center">
                      <span className="mr-2">👤</span>
                      <div>
                        <div className="font-medium">User</div>
                        <div className="text-gray-500">View and update assigned tasks</div>
                      </div>
                    </div>
                  </label>
                </div>
                  ...
                  <label htmlFor="role-admin" className="ml-3 block text-sm text-gray-700">
                    <div className="flex items-center">
                      ...
                      <div>
                        ...
                        <div className="text-gray-500">Full system access and control</div>
                      </div>
                    </div>
                  </label>
                </div>
